...
def get_links(s,base_link):
    '''
    returns all the links from s string.
    base_links is a required string parameter that represents the base link like 'www.twitter.com' or 'www.facebook.com'.
    '''
    i=0
    links=[]
    while i<len(s):
    ...
    for i in range(len(links)):
        links[i]='https://'+new+'/'+links[i]
        
    return links
                
                
def bypass_multi_eol(s):
    '''
